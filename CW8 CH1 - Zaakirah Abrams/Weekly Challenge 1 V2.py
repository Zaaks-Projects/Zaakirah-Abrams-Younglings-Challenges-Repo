...
swear_words = {"bitch", "shit", "asshole", "bastard", "slut", "bloody hell", "tief", "idiot", "stupid", "crap"}

string = input("Let us know your sentence: ")

def check(string):
    for word in string.casefold().split():
        if word in swear_words:
            print("Please choose your words wisely. It has a rude word detected:  "+word)
            return True
    print("This sentence has no rude words")
    return False
